<div align="center">
  <img src="./assets/reporter-promo/reporter.webp" alt="reporter Apple 风格渐变路径动画" width="100%" />
...
仓库提供一份无外部图片和字体依赖的 `reporter` 路径动画。字标先以 SVG 路径构建，再转换为 Skottie 兼容 Lottie，并沿自然书写方向逐字揭示：

- [查看 Lottie JSON](./assets/reporter-promo/lottie.json)
- [查看 SVG 路径源文件](./assets/reporter-promo/reporter.svg)
- [重新构建动画](./assets/reporter-promo/build.mjs)

动画使用 Apple 风格蓝紫粉渐变、ease-in-out 节奏和透明背景。`build.mjs` 仅用于维护宣传素材，不参与 Skill 运行。
